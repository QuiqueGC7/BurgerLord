...
function renderizarMenu(data) {
    ...
    // Filtrar solo las categorías de hamburguesas: "Clasicas" y "Especiales"
    const filteredData = data.filter(item => item.categoria === "Clasicas" || item.categoria === "Especiales");
...
function agregarAlCarrito(productId) {
    ...
    if (itemExistente) {
        ...
        const product = productsData.find(b => b.id === productId);
        if (product) {
            carrito.push({
                id: product.id,
